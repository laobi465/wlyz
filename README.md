...
[![Version](https://img.shields.io/badge/version-0.2.2-blue.svg)](docs/CHANGELOG.md)
...
| 平台总支付（彩虹易支付） | ⏳ 计划中 v0.2.3 | 下单/回调/自动发卡 |
| 前端业务页面（三角色 + H5） | ⏳ 计划中 v0.2.3 | 当前为骨架占位 |
...
- **v0.2.3**：平台总支付（彩虹易支付下单/回调/自动发卡）+ 前端业务页面骨架
