...
[![Version](https://img.shields.io/badge/version-0.2.5-blue.svg)](docs/CHANGELOG.md)
...
| 代理后端业务接口 | ⏳ 计划中 v0.3.0 | 当前为 501 占位，待 v0.3.0 实现 dashboard/cards/orders/commission/withdraw |
...
- **v0.3.0**：开发者自有易支付 + 代理注册付费 + 三级公告 + SDK（Python/Node/PHP）+ 代理后端业务接口
