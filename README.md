...
[![Version](https://img.shields.io/badge/version-0.3.5-blue.svg)](docs/CHANGELOG.md)
...
- **v0.3.6**：剩余 P1 收尾（卡密 CSV 导入导出、设备强制下线、安装向导页面、代理注册付费流程、开发者自有易支付、客户端 SDK 三语言）
- **v0.4.0**：三期商业化（多级代理 + 全语言 SDK + 在线更新 + 数据备份恢复 + 监控告警 + 通知系统）
