...
--
-- v0.6.2 修复：原版每行 VALUES 多写一个空字符串导致 Error 1136 (Column count doesn't match value count)
--   对比 014_notify migration 的 6 列写法，移除多余的第 3 个 '' 字段
--   列顺序对齐 sys_config 表：config_key, config_value, config_type, config_name, config_group, remark
...
('notify.telegram.chat_id',     '',  'string', 'Telegram Chat ID',       'notify', 'v0.5.0 频道=@xxx / 群组=-1001234567890 / 私聊=用户 ID')
